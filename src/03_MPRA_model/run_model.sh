...
proj_out <- MPRAmodel(count_proj, attr_proj, cond_proj, filePrefix=paste0(proj, "_", prefix), negCtrlName=negCtrl, posCtrlName=posCtrl, projectName=proj, cSkew=FALSE, prior=FALSE, method='ssn', runAllelic=FALSE)
